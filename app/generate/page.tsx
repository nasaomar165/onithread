...
export default function GenerateContent() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (contentType === "facebook" && image) {
        ...
        promptText +=
          "Generate a facebook post based on the image and the prompt.";
      }
  ...
  const renderContentMock = () => {
    ...
    switch (contentType) {
      ...
      case "facebook":
        return <FacebookMock content={generatedContent[0]} image={image} />;
      case "linkedin":
  ...
  const handleShare = async () => {
    ...
    switch (contentType) {
      ...
      case 'instagram':
        ...
        await navigator.clipboard.writeText(generatedContent[0]);
  ...
  if (!isLoaded) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
        <LoaderCircle className="w-12 h-12 animate-spin text-blue-500 mb-4" />
        <h2 className="text-2xl font-semibold mb-2">Loading OniThread AI</h2>
        <p className="text-gray-400">Preparing your content generation experience...</p>
      </div>
    );
  }
            ...
            {(selectedHistoryItem || generatedContent.length > 0) && (
              <div className="bg-gray-800 p-6 rounded-2xl space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  >
                    Share Directly 
                    <Share className="ml-2 mr-1 h-5 w-5" />
                  </Button>
                </div>
                {contentType === "twitter" ? (
                  <div className="space-y-4">
