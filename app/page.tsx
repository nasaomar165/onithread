      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center py-20 lg:py-32 relative">
          ...
          <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
            Create engaging content for X, Instagram, Linkedin and Facebook with
        ...
        <div className="py-20" id="features">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
            {[
              {
                title: "X Threads",
                icon: <TwitterIcon className="w-10 h-10 mb-4 text-white"/>,
                description:
                  "Generate compelling X threads that engage your audience and boost your reach.",
              },
              {
              ...
              },
              {
                ...
                icon: <FacebookIcon className="w-10 h-10 mb-4 text-[#1877F2]" />,
                description:
                  "Develop engaging Facebook posts that resonate with your audience and increase your page's reach.",
              },
            ].map((feature, index) => (
              <div
                key={index}
